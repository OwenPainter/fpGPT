...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--slm-engine", choices=("smollm", "microgpt", "assistant", "echo"), default="smollm",
                        help="engine for SLM transport (default: smollm)")
    parser.add_argument("--slm-temp", type=float, default=0.7,
                        help="temperature for SLM sampling (default: 0.7)")
    parser.add_argument("--slm-top-k", type=int, default=40,
                        help="top-k sampling for SLM (default: 40)")
    ...
    parser.add_argument("--timeout", type=float, default=15.0,
                        help="reply inactivity timeout in seconds (default: 15.0)")
